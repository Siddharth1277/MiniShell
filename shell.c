...
#define MAX 100
#define Welcome() printf("Welcome to Siddharth's Shell\n");
#define Instruction() printf("If you need Guide to use Siddharth's Shell type 'help'\n")
...
void show_help() {
    ...
    printf("3. exit                   - exit from the Siddharth's shell\n");
    printf("4. help                   - guide to use Siddharth's shell\n");
}
...
bool accept_commands(char* args[]) {
    ...
    if(strcmp(args[0], "exit") == 0) {
        printf("Exiting Siddharth's Shell...\n");
        exit(0);
    }
